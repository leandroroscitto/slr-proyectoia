...
%--EN ESTE MODULO PUDEN EXISTIR PREDICADOS AUXILIARES QUE
%--EN UN PRINCIPIO ERAN USADOS, PERO LUEGO SE DESCARTARON
%--NO NECESARIAMENTE TODOS LOS QUE APARECEN SON USADOS POR EL AGENTE
