...
object_at([treasure, t5, [[val, 322]]], [9, 5]).
object_at([treasure, t4, [[val, 76]]], [8, 2]).
object_at([treasure, t3, [[val, 271]]], [3, 8]).
object_at([treasure, t2, [[val, 147]]], [4, 2]).
object_at([treasure, t1, [[val, 333]]], [4, 3]).

building(hostel, h1, [1, 1], []).